...
const questions = [
    ...
    {
        question: "🎵 Какой жанр музыки я предпочитаю?",
    ...
    },
    {
        ...
        answers: ["О наших встречах", "Мой камушек и твой камушек", "Как мы будем вести себя на людях", "Как мы будем называться"],
